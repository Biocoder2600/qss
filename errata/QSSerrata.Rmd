...
* page 305.  Add a footnote to the end of the last paragraph whose last sentence ends with "approximated by the standard normal distribution."  The footnote to be added is "If one wishes to illustrate the quincunx through Monte Carlo simulations, we sample from the Bernoulli distribution or equivalently the Binomial distribution with size $n = 1$."
...
Thanks to Jeff Arnold, Masahiko Asano, Masataka Harada, Joel Gautschi, Yuko Kasuya, Soyoung Lee, and Rocio Titiunik for pointing out the errors. 
